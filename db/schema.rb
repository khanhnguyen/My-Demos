...
ActiveRecord::Schema.define(:version => 20111228040030) do
  ...
  add_index "activity_objects", ["author_id"], :name => "index_activity_objects_on_author_id"
  add_index "activity_objects", ["owner_id"], :name => "index_activity_objects_on_owner_id"
  add_index "activity_objects", ["user_author_id"], :name => "index_activity_objects_on_user_author_id"
