...
var DATA={
  "experiments": {
    "8367288": {
      ...
      "events": {
        "a#login": "Sign In", 
        "a#sign-up": "Sign Up", 
        "li#app-store a:eq(0)": "App Store", 
        "li#latimes > a:eq(0) > span:eq(0)": "Los Angeles Times", 
        "li#latimes a:eq(0) span:eq(0)": "LA Times", 
        "li#log-in a:eq(0)": "Log In", 
        "li#techcrunch > a:eq(0) > span:eq(0)": "TechCrunch", 
        "li#techcrunch a:eq(0) span:eq(0)": "TechCrunch", 
        "li#wired > a:eq(0) > span:eq(0)": "Wired", 
        "li#wired a:eq(0) span:eq(0)": "Wired", 
        "p#app-store > a:eq(0)": "App Store", 
        "p#app-store > a:eq(1)": "Android Market", 
        "ul#footer > li:eq(0) > a:eq(0)": "Blog", 
        "ul#footer > li:eq(1) > a:eq(0)": "Jobs", 
        "ul#footer > li:eq(2) > a:eq(0)": "Questions", 
        "ul#footer > li:eq(3) > a:eq(0)": "Contact", 
        "ul#footer li:eq(0) a:eq(0)": "About", 
        "ul#footer li:eq(1) a:eq(0)": "Blog", 
        "ul#footer li:eq(2) a:eq(0)": "Jobs", 
        "ul#footer li:eq(3) a:eq(0)": "Service"
      }, 
      "google_analytics_slot": null, 
      "html": "", 
      "ignore": 0, 
      "is_site_catalyst_enabled": "null", 
      "manual": false, 
      "name": "Tagline Round Two", 
      "section_ids": [], 
    ...
    "8586149": {
      ...
      "css": "", 
      "events": {
        "a.facebook": "Login with Facebook", 
        "button.default > span:eq(0)": "Done Button"
      }, 
      "google_analytics_slot": null, 
      "html": "", 
      "ignore": 0, 
    ...
    "9752134": {
      ...
      "css": "", 
      "events": {
        "a.facebook": "signup with facebook", 
        "button.default > span:eq(0)": "done button"
      }, 
      "google_analytics_slot": null, 
      "html": "", 
  ...
  "variations": {
    ...
    "8367592": {
      "code": "$(\"div#header div.wrapper h2:eq(0) a:eq(0)\").html(\"The simple way to capture<br />and share life's moments.&nbsp;\");\n$(\"div#header > div.wrapper > h2:eq(0) > a:eq(0)\").replaceWith(\"<a href=\\\"/signup\\\"><a href=\\\"/signup\\\">The simple way to capture&nbsp;and share lif</a>e&nbsp;with close friends and family</a>\");\n$(\"div#header > div.wrapper > h2:eq(0)\").replaceWith(\"<h2><a href=\\\"/signup\\\"></a><a href=\\\"/signup\\\">The simple way to capture and share <br> life with close friends and family</a></h2>\");\n$(\"div#header > div.wrapper > h2:eq(0) > a:eq(1)\").replaceWith(\"<a href=\\\"/signup\\\">The simple way to capture and <br> share life with close friends &amp; family</a>\");", 
      "name": "The simple way to capture and share life's moments."
    }, 
    "8367593": {
      "code": "", 
      "name": "The simple and private way to share life with close friends & family."
    }, 
    "8382907": {
      "code": "$(\"div#header > div.wrapper > h2:eq(0) > a:eq(0)\").replaceWith(\"<a href=\\\"/signup\\\">The simple way to share life and <br />never miss a moment with family.</a>\");", 
      "name": "The simple way to share life and never miss a moment with family."
    }, 
    "8383405": {
      "code": "", 
      "name": "Original Page"
    ...
    "8390534": {
      "code": "$(\"div#header > div.wrapper > h2:eq(0) > a:eq(0)\").replaceWith(\"<a href=\\\"/signup\\\">Be yourself and share life with<br />the people you care about.</a>\");", 
      "name": "Be yourself and share life with the people you care about."
    }, 
    "8396195": {
      "code": "$(\"div#header div.wrapper h2:eq(0) a:eq(0)\").html(\"The simple way to share&nbsp;life <br />with close friends &amp; family.&nbsp;\");", 
      "name": "The simple way to share life with close friends & family."
    }, 
    "8402382": {
      "code": "$(\"div#header div.wrapper h2:eq(0) a:eq(0)\").html(\"The simple way to capture<br />and share life's moments.&nbsp;\");\n$(\"div#header > div.wrapper > h2:eq(0) > a:eq(0)\").replaceWith(\"<a href=\\\"/signup\\\"><a href=\\\"/signup\\\">The simple way to capture&nbsp;and share lif</a>e&nbsp;with close friends and family</a>\");\n$(\"div#header > div.wrapper > h2:eq(0)\").replaceWith(\"<h2><a href=\\\"/signup\\\"></a><a href=\\\"/signup\\\">The simple way to capture and share <br> life with close friends and family</a></h2>\");\n$(\"div#header > div.wrapper > h2:eq(0) > a:eq(1)\").replaceWith(\"<a href=\\\"/signup\\\">The simple way to capture and <br> share life with close friends &amp; family</a>\");", 
      "name": "The simple way to capture and share life's moments."
    ...
    "8567748": {
      "code": "$(\"a.facebook\").replaceWith(\"<a class=\\\"facebook\\\" href=\\\"/facebook\\\">Sign Up/In with Facebook</a>\");", 
      "name": "Variation #2"
    }, 
    "8576830": {
      "code": "", 
    ...
    "8576833": {
      "code": "$(\"a.facebook\").replaceWith(\"<a class=\\\"facebook\\\" href=\\\"/facebook\\\">Log In with Facebook</a>\");", 
      "name": "Variation #3"
    }, 
    "8577231": {
      "code": "", 
    ...
    "8589578": {
      "code": "$(\"a.facebook\").replaceWith(\"<a class=\\\"facebook record-link\\\" data-action=\\\"FacebookConnect\\\" data-category=\\\"SignUp\\\" href=\\\"/facebook\\\">Register with Facebook</a>\");", 
      "name": "Variation #4"
    }, 
    "9676442": {
      "code": "", 
    ...
    "14021478": {
      "code": "$(\"div#header > div.wrapper > h2:eq(0) > a:eq(0)\").replaceWith(\"<a href=\\\"/signup\\\">The simple way to&nbsp;share life <br />with close friends &amp; family.</a>\");", 
      "name": "The simple way to share life with close friends & family."
    }, 
    "14022215": {
      "code": "$(\"div#header > div.wrapper > h2:eq(0) > a:eq(0)\").replaceWith(\"<a href=\\\"/signup\\\">The simple and private way to<br />share life with loved ones.</a>\");", 
      "name": "The simple and private way to share life with loved ones."
    }, 
    "14037012": {
      "code": "$(\"div#header > div.wrapper > h2:eq(0) > a:eq(0)\").replaceWith(\"<a href=\\\"/signup\\\">The Smart Journal.</a>\");", 
      "name": "The Smart Journal"
    }, 
    "16530859": {
      "code": "", 
      "name": "Variation #1"
...
var h=void 0,i=null;function aa(a,b){b=b===!0;if(!j)return!1;var c=i,d=[],e=[];k(a)?d.push(a):m(n(),function(a){o(a,"manual")&&d.push(a)});m(d,function(a){if(b||ba(a,!0))(c=ca(a,b))&&e.push(a)});da(e);ea();fa()}
function ga(a,b){ha=!0;j&&q.e(document.location.href);a=String(a);b=String(b);if(b==="-1"){var c=a;r[c]&&delete r[c];t[c]&&delete t[c];for(var d=0;d<u.length;d++)u[d].h===c&&u.splice(d,1)}else if((c=w(a))&&c.length>0){var c=a,d=b,e;a:{e=w(c);for(var f=0;f<e.length;f++){var g=x(e[f]);if(z(g,d)){e=e[f];break a}}e=""}A[c]=A[c]||{};A[c][e]=d;B("Distributor","Preferring variation partial "+d+" of section "+e+" of experiment "+c);c=ia(c);c.length===1&&C(c[0],"api.bucketUser",!1,!0)}else C(b,"api.bucketUser",
!1,!0);ea()}function ja(){E=j=!1}function ka(a,b){var c=[],d=b;F(b)&&(c=Array.prototype.slice.call(b,1,b.length),d=b[0]);var e=a[d];e?(B("API",'Called function "'+d+'"'),d!=="acknowledgePreviewMode"&&G(d,{type:"api"}),e.apply(i,c)):B("API",'Error for unknown function "'+d+'"');na()}
function oa(){pa={};I={};qa={};m(J(),function(a){var b=K(a);pa[b]=a.split("_");var c=I,d;a:{var e=K(a);d=w(e);if(d.length===0){d=ra(e);for(e=0;e<d.length;e++)if(d[e]===a){d=e;break a}}else{for(var e=a.split("_"),f=[],g=0;g<d.length;g++)for(var l=x(d[g]),v=0;v<l.length;v++)l[v]===e[g]&&f.push(v);if(f!==[]){d=f;break a}}d=-1}c[b]=d;qa[b]=sa(a)});ta(window.optimizely,{activeExperiments:ua,allExperiments:va(),all_experiments:va(),variationIdsMap:pa,variationMap:I,variationNamesMap:qa,variation_map:I})}
function wa(a){if(!k(a))return!1;xa=Number(a)}function ya(){za=!0}var pa={},I={},qa={};function z(a,b){for(var c=0;c<a.length;c++)if(b==a[c])return!0;return!1}function Aa(a,b){var c=Array.prototype.slice.call(arguments,1,arguments.length);return function(){var b=Array.prototype.slice.call(arguments,0,arguments.length);b.unshift.apply(b,c);return a.apply(this,b)}}function m(a,b){var c=i;if(F(a))for(var d=a.length,e=0;e<d;++e){if(c=b.call(h,a[e],e),L(c))break}else for(d in a)if(Object.prototype.hasOwnProperty.call(a,d)&&(c=b.call(h,d,a[d]),L(c)))break;return c}
function ta(a,b){m(b,function(b,d){a[b]=d})}function Ba(a,b){return m(b,function(b){if(b===a)return!0})||!1}function F(a){return a&&typeof a==="object"&&a.length&&typeof a.length==="number"}function L(a){return typeof a!=="undefined"}function k(a){return(typeof a==="number"||typeof a==="string")&&Number(a)==a}function Ca(a){Ca=Object.keys||function(a){var c=[];m(a,function(a){c.push(a)});return c};return Ca.call(i,a)}
function Ea(a){var b=document.K||document.getElementsByTagName("head")[0]||document.documentElement,c=document.createElement("script");c.src=a;c.type="text/javascript";b.appendChild(c)}function Fa(a){return a.replace(/^[\s\xa0]+|[\s\xa0]+$/g,"")};function Ga(){if(Ha===i){for(var a=n(),b=Ia,c=[],d=0,e=a.length;d<e;d++){var f=a[d];b(f)&&c.push(f)}Ha=c}return Ha}function va(){return M("experiments")||{}}function n(){return Ca(M("experiments")||{})}function N(a){return'experiment "'+(o(a,"name")||"")+'" ('+a+")"}function w(a){return o(a,"section_ids")||[]}function ra(a){return o(a,"variation_ids")||[]}function x(a){return M("sections",a,"variation_ids")||[]}
function Ja(a){var b=[];m(a.split("_"),function(a){(a=M("variations",a,"code"))&&b.push(a)});return b.join("\n")}function K(a){var b={};m(n(),function(a){m(w(a),function(d){m(x(d),function(d){b[d]=a})});m(ra(a),function(d){b[d]=a})});K=function(a){return b[a.split("_")[0]]||""};return K.call(i,a)}function sa(a){var b;return Ka(a).join(b||", ")}function Ka(a){var b=[];m(a.split("_"),function(a){b.push(M("variations",a,"name")||"Unnamed")});return b}function Ia(a){return!!o(a,"active")}
function o(a,b){return M("experiments",a,b)}function M(a){var b=DATA;if(m(arguments,function(a){a=b[a];if(L(a))b=a;else return i})!==i)return b}var Ha=i;function G(a,b){b=b||{};window.optimizelyPreview=window.optimizelyPreview||[];La||(window.optimizelyPreview.push(["addEvent",window.location.href,{type:"url"}]),La=!0);window.optimizelyPreview.push(["addEvent",a,b])}function Ma(){B("Preview","Preview acknowledgement received")}var La=!1;function Na(){var a=window.location.search||"";a.indexOf("?")===0&&(a=a.substring(1));for(var a=a.split("&"),b=[],c=0;c<a.length;c++){var d="",e="",f=a[c].split("=");f.length>0&&(d=f[0]);f.length>1&&(e=f[1]);b.push([d,e])}return b}function Oa(){for(var a=window.location.search,b,c=/optimizely_([^=]+)=([^&]*)/g,d={};b=c.exec(a);)d[b[1]]=decodeURIComponent(b[2]);a.indexOf("OPTIMIZELY_TEST_MODULE")!==-1&&(d.test_module=!0);return d}
function Pa(a,b){var c=w(a),d=[];if(b.length===1){var c=ra(a),e=b[0],f=c[e];!f&&z(c,e)&&(f=e);f&&d.push(f)}else c.length===b.length&&m(c,function(a,c){var e=b[c];if(e=x(a)[e])d.push(e);else return d=[],i});return d.join("_")}var Qa="//cdn.optimizely.com/,https://cdn.optimizely.com/,//optimizely.appspot.com/,https://optimizely.appspot.com/,//www.local/,https://www.local/,//www-local.optimizely.com/,https://www-local.optimizely.com/".split(",");function ba(a,b){b=b===!0;B("Condition","Testing experiment "+a);var c=Ia(a),d=o(a,"manual")||!1;if(c)if(Ra(a)){if(!b&&d)return B("Condition"," Failed for experiment "+a+" (manual activation mode)"),O[a]="it is set to use manual activation mode",!1}else return B("Condition","Failed for experiment "+a+" (condition failed)"),!1;else return B("Condition","Failed for experiment "+a+" (paused)"),O[a]="it is paused",!1;return!0}
function Ra(a){var b=o(a,"conditions")||[],c=!0;m(b,function(b){var e=b.type;if(b.only_first_time&&Sa(a))B("Condition",e+" condition passed because it only gets checked when bucketing",!0);else{var f=!b.not,g=(0,Ta[e])(b),b=g!==f,g=g?"passed":"failed",f=f?"pass":"fail";B("Condition",e+" condition "+g+" when expected to "+f,!b);if(b)return c=!1,O[a]=e+" condition "+g+" when expected to "+f,!1}});return c}
var Ta={browser:function(a){var b=Ua(),c=Va(),d=!1,e=Wa();m(a.values,function(a){e!=="unknown"?d=a==="mobile":a.indexOf(b)===0&&(a=a.substr(b.length),d=a===""||a<=c&&c<Number(a)+1);if(d)return i});return d},code:function(a){a=a.value;if(a===h)return!0;try{return Boolean(eval(a))}catch(b){return!1}},cookie:function(a){var b=a.value,a=P(a.key);return L(b)&&Fa(b)!==""?b===a:a!==i&&a!==h},event:function(a){var b=P("optimizelyCustomEvents")||"{}";try{b=$.parseJSON(b)}catch(c){b={}}var d=b[Xa()]||[];F(d)||
(d=[]);var e=!1;m(a.values,function(a){if($.inArray(a,d)!==-1)return e=!0});return e},language:function(a){var b=Ya(),c=!1;m(a.values,function(a){if(c=a==="any"||b.indexOf(a)===0)return i});return c},query:function(a){if(a.values.length===0)return!0;var b=!1,c=Na();m(a.values,function(a){for(var e=a.key,a=a.value,f=0;f<c.length;f++){var g=c[f],l=g[0],g=g[1];if(e!==""&&e===l&&(a===""||a===g))return b=!0}});return b},referrer:function(a){for(var b=0;b<a.values.length;b++){var c=a.values[b];if(Za(document.referrer,
c.value,c.match))return!0}return!1},url:function(a){for(var b=0;b<a.values.length;b++){var c=a.values[b];if(Za(window.location.href,c.value,c.match))return!0}return!1},visitor:function(a){var b=$a?"returning":"new";switch(a.value){case "new":return b==="returning"?!1:!0;case "returning":return b==="returning"}return!0}};var ab="com,local,net,org,xxx,edu,es,gov,biz,info,fr,nl,ca,de,kr,it,me,ly,tv,mx,cn,jp,il,in,iq".split(",");function P(a){var b=a+"=";return m((document.cookie||"").split(/\s*;\s*/),function(a){if(a.indexOf(b)===0)return decodeURIComponent(a.substr(b.length))})}
function Q(a,b,c){var d,e;if(!d){var f=document.location.hostname;d=f;var f=f.split("."),g=f[f.length-1];f.length>2&&f[f.length-2]==="appspot"&&g==="com"?d="."+f[f.length-3]+".appspot.com":f.length>1&&Ba(g,ab)&&(d="."+f[f.length-2]+"."+f[f.length-1])}a=[a,"=",encodeURIComponent(b),"; domain=",d,"; path=",e||"/"];c&&a.push("; expires=",(new Date(+new Date+c*1E3)).toUTCString());document.cookie=a.join("")};function bb(){var a=navigator.userAgent,b=cb([{id:"gc",substring:"Chrome",g:"Chrome"},{id:"safari",G:navigator.vendor,substring:"Apple",g:"Version"},{id:"ff",substring:"Firefox",g:"Firefox"},{id:"opera",prop:window.opera,g:"Opera"},{id:"ie",substring:"MSIE",g:"MSIE"},{id:"mo",substring:"Gecko",g:"rv"}],a),c=cb([{id:"android",substring:"Android"},{id:"blackberry",substring:"BlackBerry"},{id:"ipad",substring:"iPad"},{id:"iphone",substring:"iPhone"},{id:"ipod",substring:"iPod"},{id:"windows phone",substring:"Windows Phone"}],
a),d=i,e=b.g;e&&(d=db(a,e)||db(navigator.appVersion,e));return{r:b.id||"unknown",t:d||"unknown",D:c.id||"unknown"}}function db(a,b){var c=a.indexOf(b),d=i;c!==-1&&(c+=b.length+1,d=parseFloat(a.substring(c)));return d}function cb(a,b){return m(a,function(a){var d=a.G||b;if(d&&d.indexOf(a.substring)!==-1||a.prop)return a})||{}};var xa=0,j=!0,R=!1,S="",T=!1,eb=!1,ha=!1,za=!1,E=!0;function ca(a,b){var b=b===!0,c=fb(a);if(c&&c.length>0)return B("Distributor","Not distributing experiment "+a+" (already in plan)"),!0;if(b||a in r)return B("Distributor","Not distributing experiment "+a+" (is ignored)"),!1;c=o(a,"active_variation_ids")||[];if(c.length===0)return B("Distributor","Permanently ignoring experiment "+a+" (no active variations)"),gb(a),!1;else{var d=o(a,"ignore")||0;if(d>Math.floor(Math.random()*100))return B("Distributor","Permanently ignoring experiment "+a+"("+d+"% likelihood)"),
gb(a),!1;else{var d=Math.floor(Math.random()*c.length),e=c[d];A[a]!==h&&(B("Distributor","Taking into account bucketUser variations for experiment "+a),e=ia(a),d=Math.floor(Math.random()*e.length),e=e[d]);B("Distributor","Picked variation "+e+" [index "+d+" of "+c.length+"]");C(e,"distributor",!1);return!0}}}function ia(a){for(var b=o(a,"active_variation_ids")||[],c=[],d=0;d<b.length;d++){var e=!0,f=h;for(f in A[a])b[d].indexOf(A[a][f])===-1&&(e=!1);e&&c.push(b[d])}return c}var A={};function da(a){if(j){F(a)?hb(a):(a=[],hb());a=a.concat(U);U=[];for(var b=0;b<a.length;b++)z(ua,a[b])||ua.push(a[b]);a=ib(a);V.push.apply(V,a);jb()}}
function jb(){var a=!1;kb=i;for(B("Evaluator",lb+" times waited");!a&&V.length>0;){B("Evaluator",V.length+" steps remaining");var b=V.shift(),c=b,a=!1;if(c.J&&!mb)B("Evaluator","Document not ready yet"),a=!0;else if(c.i&&!mb&&(c=c.f))for(var c=F(c)?c:[c],d=0;d<c.length;d++){var e=c[d];if(!(e===i||e===h||!e.length)&&$(e).length===0)B("Evaluator","'"+e+"' not found"),a=!0}a?V.unshift(b):b.j?(B("Evaluator","Bound event "+b.j+" to selector "+b.f),nb(b.f,b.j)):b.code&&(B("Evaluator","Run code: "+b.code),
ob(b.code))}a?(kb=setTimeout(jb,lb===0?10:50),lb++):B("Evaluator",lb+" total times waited")}
function ob(a){if(a.indexOf("_optimizely_redirect")!==-1){B("Evaluator","Redirect detected");var b=P("optimizelyRedirect");if(b===h||b===i||b==="")B("Evaluator","OK to redirect"),Q("optimizelyRedirect",window.location.href,5),Q("optimizelyReferrer",document.referrer||"http://www.optimizely.com/redirect-no-referrer");else{B("Evaluator","NOT OK to redirect");return}}eval("var $j = $;");try{eval(a)}catch(c){b=T,T=!0,B("Evaluator","Error: "+c.message),B("Evaluator","Code: "+a),T=b,B("Evaluator","Failed to run code: "+
c.message)}}function nb(a,b){var c="mousedown",d=Wa();if(d==="iphone"||d==="ipad"||d==="ipod")c="touchstart";$(a).bind(c,function(){q.e.call(q,b,"custom")})}function pb(a){qb=a}function hb(a){a||(a=n());for(var b=0;b<a.length;b++){var c=a[b],d=O[c];d?(G("Not activating "+N(c)+" because "+d+".",{type:"explanation"}),delete O[c]):G("Activating "+N(c)+".",{type:"explanation"})}}var ua=[],U=U||[],qb=0,mb=!1,O={},V=[],kb=i,lb=0;
$(function(){mb=!0;kb!==i&&(B("Evaluator","Document is ready"),clearTimeout(kb),qb>0?setTimeout(jb,qb):jb())});var rb,sb;
(function(){function a(a){d.lastIndex=0;return d.test(a)?'"'+a.replace(d,function(a){var b=g[a];return typeof b==="string"?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function b(c,d){var g,H,D,la,ma=e,y,p=d[c];typeof l==="function"&&(p=l.call(d,c,p));switch(typeof p){case "string":return a(p);case "number":return isFinite(p)?String(p):"null";case "boolean":case "null":return String(p);case "object":if(!p)return"null";e+=f;y=[];if(Object.prototype.toString.apply(p)==="[object Array]"){la=
p.length;for(g=0;g<la;g+=1)y[g]=b(g,p)||"null";D=y.length===0?"[]":e?"[\n"+e+y.join(",\n"+e)+"\n"+ma+"]":"["+y.join(",")+"]";e=ma;return D}if(l&&typeof l==="object"){la=l.length;for(g=0;g<la;g+=1)typeof l[g]==="string"&&(H=l[g],(D=b(H,p))&&y.push(a(H)+(e?": ":":")+D))}else for(H in p)Object.prototype.hasOwnProperty.call(p,H)&&(D=b(H,p))&&y.push(a(H)+(e?": ":":")+D);D=y.length===0?"{}":e?"{\n"+e+y.join(",\n"+e)+"\n"+ma+"}":"{"+y.join(",")+"}";e=ma;return D}}var c=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
d=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,e,f,g={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},l;sb=function(a,c,d){var g;f=e="";if(typeof d==="number")for(g=0;g<d;g+=1)f+=" ";else typeof d==="string"&&(f=d);if((l=c)&&typeof c!=="function"&&(typeof c!=="object"||typeof c.length!=="number"))throw Error("JSON.stringify");return b("",{"":a})};rb=window.JSON&&typeof window.JSON.parse===
"function"?window.JSON.parse:function(a,b){function d(a,c){var e,f,g=a[c];if(g&&typeof g==="object")for(e in g)Object.prototype.hasOwnProperty.call(g,e)&&(f=d(g,e),f!==h?g[e]=f:delete g[e]);return b.call(a,c,g)}var e,a=String(a);c.lastIndex=0;c.test(a)&&(a=a.replace(c,function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));if(/^[\],:{}\s]*$/.test(a.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,
"")))return e=eval("("+a+")"),typeof b==="function"?d({"":e},""):e;throw new SyntaxError("JSON.parse");}})();function W(a,b,c){var d;window.JSON&&typeof window.JSON.stringify==="function"?(window.JSON.stringify([]).replace(/\s/g,"")!=="[]"?(B("Compatibility","WARNING: window.JSON.stringify does not serialize arrays properly. Are you using a library (e.g. Prototype v < 1.7) that overrides native JSON serialization?",!1),d=!0):d=!1,d=d?W=sb:window.JSON.stringify):d=W=sb;return d(a,b,c)};function tb(){if(E){var a=ub||(typeof window.s!=="undefined"?window.s:i);a?m(J(),function(b){var c=K(b),d=o(c,"is_site_catalyst_enabled")!=="custom_variables"?-1:o(c,"site_catalyst_evar")||-1;d!==-1&&(b=vb(c,b,100,100,25),a["eVar"+d]=b.key+": "+b.value)}):B("Integrator","Error with SiteCatalyst integration: 's' variable not defined")}}function wb(a,b){return a.replace(/[^a-zA-Z0-9\.\~\!\*\(\)\']+/g,"_").substring(0,b)}
function vb(a,b,c,d,e){a=xb+(o(a,"name")||"");b=Ka(b);b.length>1?(b=$.map(b,function(a){return a.substr(0,e-1)}),b=b.join("~")):b=b[0];a=wb(a,c);b=wb(b.replace("#",""),d);return{key:a,value:b}}
function fa(){E&&m(J(),function(a){var b=K(a);if(o(b,"google_analytics_slot")){window._gaq=window._gaq||[];var c=o(b,"google_analytics_slot")||0,d=window._gaq,e=vb(b,a,28,24,5);try{d.push(["_setCustomVar",c,e.key,e.value,2])}catch(f){B("Integrator","Error sending Google Analytics data for "+N(b))}}if(M("kissmetrics")){window._kmq=window._kmq||[];c=window._kmq;a=vb(b,a,100,100,15);d={};d[a.key]=a.value;try{c.push(["set",d])}catch(g){B("Integrator","Error sending KISSmetrics data for "+N(b))}}})}
function yb(){var a=P("optimizelyReferrer");if(a&&a.length>0){a="_gaq.push(['_setReferrerOverride', '"+a+"']);";try{eval(a)}catch(b){B("Integrator","Error with _gaq.push (Google Analytics integration):"+a)}Q("optimizelyReferrer","")}}function zb(a){xb=a}function Ab(a){ub=a}var xb="Optimizely_",ub=i;function Za(a,b,c){var d="";switch(c){case "exact":return a=X(a),a=Bb(a,"optimizely_log"),a=Bb(a,"optimizely_verbose"),d=X(b),B("Match","Exact match checking "+a+" and "+d,!0),a===d;case "regex":try{return B("Match","RegEx match checking "+a+" with "+b,!0),Boolean(a.match(b))}catch(e){return!1}case "simple":return a=X(Cb(a)),b=X(Cb(b)),B("Match","Simple match checking "+a+" with "+b,!0),a===b;case "substring":return a=X(a),b=X(b),B("Match","Substring match checking if "+a+" contains "+b,!0),a.indexOf(b)!==
-1;default:return!1}}function Cb(a){var b=a.indexOf("?");b!==-1&&(a=a.substring(0,b));b=a.indexOf("#");b!==-1&&(a=a.substring(0,b));return a}function Bb(a,b){return a.replace("&"+b+"=true","").replace("?"+b+"=true&","?").replace("?"+b+"=true","")}function X(a){for(var a=a.toLowerCase(),b=a.charAt(a.length-1);b==="/"||b==="&"||b==="?";)a=a.substring(0,a.length-1),b=a.charAt(a.length-1);m(Db,function(b){a.indexOf(b)===0&&(a=a.substring(b.length))});return a}
var Db=["http://edit.local/","http://preview.optimizely.com/","http://","https://","www."];function C(a,b,c,d){var c=c===!0,d=d===!0,e=K(a);if(e&&(d||!Sa(e))){if(d&&Sa(e))for(d=0;d<u.length;d++)u[d].h===e&&u.splice(d,1);u.push({h:e,id:a,source:b});c&&(U=U||[],U.push(e));t[e]=!0;Eb();B("Plan","Added experiment "+e+" and variation id "+a+" to the plan, source is "+b,!0)}}function Sa(a){return a in r||a in t}
function ib(a){a===h?a=[]:k(a)&&(a=[a]);var b=J(a),c=[],d=[],e=[],f=[];m(a,function(a){Fb(a,c,e,d,f)});m(b,function(a){a=Ja(a);Gb(a,d,f)});a=[];a.push.apply(a,d);a.push.apply(a,e);a.push.apply(a,f);a.push.apply(a,c);return a}function fb(a){var b=i;m(u,function(c){if(a==c.h)b=c.id});return b}function J(a){var b=[],c=!L(a),a=a||[];m(u,function(d){(c||z(a,d.h))&&b.push(d.id)});return b}function gb(a){var b;if(b===!0||!Sa(a))r[a]=!0}
function ea(){var a={};m(u,function(b){var c=K(b.id);a[c]=b.id});m(r,function(b){a[b]="0"});Q("optimizelyBuckets",W(a),31536E4)}function Eb(){m(Hb,function(a){a()})}
function Fb(a,b,c,d,e){var f=o(a,"events")||{};m(f,function(c,d){b.push({j:d,f:c,type:"event '"+d+"' (experiment "+a+")",i:!0})});var f=o(a,"css")||"",g=o(a,"code")||"",l=o(a,"html")||"";l&&c.push({code:'$("body").append("<div style=\'display:none\'>'+l.replace(/([\f\n\r\t\\'"])/g,"\\$1")+'</div>");',f:"body",type:"global html (experiment "+a+")",i:!0});f&&c.push({code:'$("body").append("<style>'+f.replace(/([\f\n\r\t\\'"])/g,"\\$1")+'</style>");',f:"body",type:"global css (experiment "+a+")",i:!0});
g&&Gb(g,d,e)}
function Gb(a,b,c){if(a.indexOf("_optimizely_redirect")!==-1)b.push({code:a,type:"code forced (redirect)"});else{for(var a=a.split("\n"),d=!1,e=[],f=[];a.length>0;){var g=Fa(a.shift()),l=f.length>0;if(g)if(g.indexOf("_optimizely_evaluate=force")!==-1)d=!0;else if(g.indexOf("_optimizely_evaluate=safe")!==-1)d=!1;else if(d)e.push(g);else{if(!l){var v=Ib.exec(g),Da=[];v?(Da.push(v[1]),(v=Jb.exec(g))&&v.length>4&&Da.push(v[4]),c.push({code:g,f:Da,type:"safe jquery",i:!0})):l=!0}l&&f.push(g)}}e.length>0&&
b.push({code:e.join("\n"),type:"forced evaluation"});f.length>0&&c.push({code:f.join("\n"),type:"safe non-jquery",J:!0})}}var Hb=[],r={},Ib=/^\$j?\(['"](.+?)['"]\)\..+;\s*$/,Jb=/^\$j?\(['"](.+?)['"]\)\.detach\(\)\.(appendTo|insertAfter|insertBefore|prependTo)\(['"](.+?)['"]\);\s*$/,t={},u=[];function B(a,b,c){Kb.push({v:new Date,u:a,message:b,m:c||!1});Lb&&na()}function na(){T&&(m(Kb,function(a){if(!a.B&&(!a.m||a.m===eb)){var b=+a.v;T&&window.console&&window.console.log&&window.console.log("Optimizely / "+a.u+" / "+a.message+(" [time "+(Mb?b-Mb:0)+" +"+(Nb?b-Nb:0)+"]"));Nb=b;Mb||(Mb=b);a.B=!0}}),Lb=!0)}var Nb=i,Mb=i,Kb=[],Lb=!1;var q={};q.e=function(a,b,c){b&&k(b)&&c===h&&(c=Number(b),b="custom");R&&(k(c)?G(a,{value:c}):G(a));E&&(q.k.push({name:a,type:b,value:c}),q.q&&q.n(),B("Tracker","Tracking event '"+a+"'"))};q.w=function(){$("html").one("mousedown",Aa(q.e,"engagement"))};q.z=function(a){return function(){q.F(a)}};
q.l=function(){var a=P("optimizelyPendingLogEvents")||"[]",b=[];try{b=$.parseJSON(a)}catch(c){}if(F(b))for(var a=0,d=b.length;a<d;a++){var e=b[a];if(typeof e!=="string"){b=[];break}else try{$.parseJSON(e);b=[];break}catch(f){}}else b=[];return b};q.C=function(a,b){var c=new Image;c.onload=b;c.src=document.location.protocol+"//log.optimizely.com/event?"+a};q.F=function(a){for(var b=q.l(),c=0,d=b.length;c<d;c++)if(b[c]===a){b.splice(c,1);break}q.p(b)};q.k=[];q.q=!1;
q.n=function(){var a=["a="+M("id"),"u="+Xa(),"y="+!!M("ip_anonymization")];ha&&a.push("override=true");m(J(),function(b){var c=K(b);a.push("x"+c+"="+b)});a.push("f="+Ga().join(","));var b=a.join("&"),c=[];m(q.k,function(a){var b=[];a.name&&b.push("n="+encodeURIComponent(a.name));a.value&&b.push("v="+encodeURIComponent(a.value));b.push("t="+ +new Date);c.push(b.join("&"));if(a.type==="custom")try{q.I(a.name)}catch(d){}});var d=c.concat(q.l());q.p(d);d=q.o?c:d;q.o=!0;for(var e=0,f=d.length;e<f;e++){var g=
d[e];q.C(b+"&"+g,q.z(g))}q.k=[];q.q=!0};q.p=function(a){for(var b=W(a);b.length>1536;)a=a.slice(0,-1),b=W(a);Q("optimizelyPendingLogEvents",b,15)};
q.I=function(a){var b=Xa(),c=P("optimizelyCustomEvents")||"{}";try{c=$.parseJSON(c)}catch(d){c={}}var e=c[b]||(c[b]=[]),e=F(e)?e:[];$.inArray(a,e)!==-1&&e.splice($.inArray(a,e),1);e.push(a);e.length>10&&e.shift();c[b]=e;var a=0,e=i,f=0,g;for(g in c)if(c.hasOwnProperty(g)&&(a++,c[g].length>f&&g!==b))e=g,f=c[g].length;a>10&&e!==i&&delete c[e];Q("optimizelyCustomEvents",W(c),31536E4)};q.o=!1;var Y;function Ua(){function a(){return Y.r}Y=Y||bb();Ua=a;return a()}function Ya(){var a="";try{a=navigator.userLanguage||window.navigator.language,a=a.toLowerCase()}catch(b){a=""}return a}function Va(){function a(){return Y.t}Y=Y||bb();Va=a;return a()}function Xa(){var a=P("optimizelyEndUserId");a||(a="oeu"+ +new Date+"r"+Math.random(),Q("optimizelyEndUserId",a,31536E4));return a}function Wa(){function a(){return Y.D}Y=Y||bb();Wa=a;return a()}var $a=h;function Ob(a){return function(b){if(typeof b==="object"&&Pb()){var c=i,d;for(d in b)b.hasOwnProperty(d)&&(c=a.call(this,d,b[d]));return c}else return a.apply(this,arguments)}}function Pb(){for(var a in{})return!0;return!1};var Z=$;Z.fn.attr=Ob(Z.fn.attr);Z.fn.css=Ob(Z.fn.css);Z.fn.extend=Ob(Z.fn.extend);Z.each=function(){var a=Z.each;return function(b,c,d){if((b.length===h||Z.isFunction(b))&&Pb())if(d)for(var e in b){if(b.hasOwnProperty(e)&&c.apply(b[e],d)===!1)break}else for(e in b){if(b.hasOwnProperty(e)&&!c.call(b[e],e,b[e])===!1)break}else a.apply(this,arguments);return b}}();
Z.fn.A=function(){var a=Z.fn.A;return function(b,c,d){return typeof b==="string"&&c&&Z.type(c)==="object"&&Pb()?(b=new a(b,h,d),b.attr(c),b):new a(b,c,d)}}();B("Main","Started, revision "+M("revision"));
(function(){var a=Oa(),b=/x(\d+)/,c=!1;m(a,function(a,d){var g=b.exec(a);g&&(c=!0,g=Pa(g[1],d.split("_")),C(g,"query",!0))});if(a.opt_out==="true"||a.opt_out==="false")Q("optimizelyOptOut",a.opt_out,31536E4),Q("optimizelyBuckets",a.opt_out,31536E4),a.opt_out==="true"&&alert("You have successfully opted out of Optimizely for this domain.");j=a.disable!=="true"&&a.opt_out!=="true"&&P("optimizelyOptOut")!=="true";R=(a.preview||R)&&j&&!a.cross_browser;S=a.load_script;T=a.log==="true";eb=a.verbose==="true";
E=!c||a.force_tracking==="true";a.client==="false"&&(j=!1,S="js/"+M("id")+".js");if(S){var d=!1;m(Qa,function(a){if(S.substring(0,a.length)==a)return d=!0});d||(S="")}})();var Qb=P("optimizelyBuckets"),$a=Qb!==h&&Qb!==i;
(function(){var a=P("optimizelyBuckets");if(a){var a=rb(a),b={};m(a,function(a,d){var d=String(d),e=K(d);w(e).length>1&&d.indexOf("_")===-1?(b[e]=b[e]||{},b[e][a]=d):d!=="0"?C(d,"cookie",!1):gb(a)});m(b,function(a,b){var e;a:{e=[];for(var f=w(a),g=0;g<f.length;g++){var l=b[f[g]];if(l==="0"){e="";break a}e.push(l)}e=e.join("_")}e.length>0?C(e,"cookie",!1):gb(a)})}})();
(function(){Hb.push(oa);var a={$:$,activeExperiments:ua||[],allExperiments:va(),all_experiments:va(),allVariations:M("variations")||{},revision:M("revision"),variationIdsMap:pa,variation_map:I,variationMap:I,variationNamesMap:qa},b={},c=Aa(ka,b);ta(b,{acknowledgePreviewMode:Ma,activate:aa,bucketUser:ga,delayDomReadyEval:pb,delayPageviewTracking:wa,disable:ja,integrationPrefix:zb,push:c,sc_activate:tb,sc_svar:Ab,skipPageTracking:ya,trackEvent:q.e});ta(a,b);b=window.optimizely;F(b)&&m(b,function(a){c(a)});
window.optimizely=a})();B("Info","Is enabled: "+j);B("Info","Is previewing: "+R);B("Info","Script to load: "+(S||"none"));B("Info","Browser type: "+Ua());B("Info","Browser version: "+Va());var Rb=Wa();Rb!=="unknown"&&B("Info","Mobile browser type: "+Rb);B("Info","Visitor type: "+($a?"returning":"new"));B("Info","User ID: "+Xa());S&&Ea(S);
j&&(m(n(),function(a){!Ba(a,U)&&ba(a)&&(B("Distributor","Going to distribute "+N(a)),ca(a)&&(U=U||[],U.push(a)))}),ea(),q.w(),za||(xa>0?setTimeout(function(){q.e(document.location.href)},xa):q.e(document.location.href)),q.n(),fa(),yb());T&&(m(r,function(a){var b=o(a,"name")||"";B("Plan","Ignore experiment '"+b+"' ("+a+")")}),m(u,function(a){var b=K(a.id),c=sa(a.id);B("Plan",N(b)+' in variation "'+c+'" ('+a.id+")")}));j&&(da(),oa(),na());
if(R)window.optimizelyPreview=window.optimizelyPreview||[],B("Preview","Will load preview script"),$(document).ready(function(){var a="//optimizely.s3.amazonaws.com/js/"+M("id")+"_preview.js?account_id="+M("id")+"&no_cache="+Math.floor(1E9*Math.random());Ea(a);B("Preview","Now loading preview script "+a)});
