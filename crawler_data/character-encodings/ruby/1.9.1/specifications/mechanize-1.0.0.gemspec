...
<<<<<<< HEAD
  ...
  s.extra_rdoc_files = [%q{Manifest.txt}, %q{CHANGELOG.rdoc}, %q{EXAMPLES.rdoc}, %q{FAQ.rdoc}, %q{GUIDE.rdoc}, %q{LICENSE.rdoc}, %q{README.rdoc}]
  s.files = [%q{Manifest.txt}, %q{CHANGELOG.rdoc}, %q{EXAMPLES.rdoc}, %q{FAQ.rdoc}, %q{GUIDE.rdoc}, %q{LICENSE.rdoc}, %q{README.rdoc}]
